...
const outstationTypeBox =
document.getElementById('outstationTypeBox');

const addPlaceBox =
document.getElementById('addPlaceBox');

const hourlyRentalBox =
document.getElementById('hourlyRentalBox');
...
const outstationType =
document.getElementById('outstationType');

const returnBox =
document.getElementById('returnBox');

outstationType.addEventListener('change',()=>{

if(outstationType.value === 'Roundtrip'){
...
const carSelection =
document.getElementById('carSelection');
...
'<option value="">Select Passenger Count First</option>';
...
options=[
"Swift Dzire / Hyundai Xcent / Tata Zest",
"Scorpio / Innova / Ertiga",
...
alert("Please Contact Helpline Number: 9007350757");
...
let hourly =
document.getElementById("hourlyPackage").value;

let outstationType =
document.getElementById("outstationType").value;
...
let addPlace =
document.querySelector("#addPlaceBox input").value;
...
let otherInfo =
document.querySelector("#ride textarea").value;
...
let pickupDate =
formatDateTime(pickupDateRaw);

let returnDate =
formatDateTime(returnDateRaw);
...
document.getElementById("previewPopup").style.display =
"flex";
...
let requiredFields =
document.querySelectorAll("#school input[required]");
...
let phone =
document.querySelectorAll("#school input")[4].value;
...
let inputs =
document.querySelectorAll("#attach input");
...
let fuel =
document.querySelector("#attach select").value;

let reg = inputs[5].value;
let garage = inputs[6].value;

let otherInfo =
document.querySelector("#attach textarea").value;
...
let requiredFields =
document.querySelectorAll("#attach input[required]");
...
let phone =
document.querySelectorAll("#attach input")[1].value;
...
document.getElementById("outstationTypeBox").style.display =
"none";

document.getElementById("returnBox").style.display =
"none";

document.getElementById("addPlaceBox").style.display =
"none";

document.getElementById("hourlyRentalBox").style.display =
"block";
